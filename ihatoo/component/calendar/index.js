! function(e) {
  ...
  const g = {
      ...
      whenSingleSelect(e) {
        ...
        }), s && (o = s.filter(e => +e.year === u && +e.month === h)), (0, r.default)(b).showTodoLabels(o, a, n);
        const m = {
          "calendar.days": a
        };
      ...
      whenChooseArea(e) {
        return new Promise((t, a) => {
          ...
          if (!o.disable) {
            ...
            if (s && s.length > 1) {
              const e = g.calculateDateRange(o, u.sortDates(s));
            ...
            if (r || s && 1 === s.length) {
              const e = r || s[0];
              let n = [e, o];
              const c = (0, d.getDateTimeStamp)(o);
              return (0, d.getDateTimeStamp)(e) > c && (n = [o, e]), g.gotoSetContinuousDates(...n).then(e => {
                t(e), g.afterTapDay(o)
              }).catch(e => {
                a(e), g.afterTapDay(o)
              })
